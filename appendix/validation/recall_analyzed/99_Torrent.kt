 ...
 */
class Torrent(torrent: JSONObject) { //#func_with_default_value
    val categories = arrayOf("_", "3_", "3_12", "3_5", "3_13", "3_6", "2_", "2_3", "2_4", "4_", "4_7", "4_14", "4_8", "5_", "5_9", "5_10", "5_18", "5_11", "6_", "6_15", "6_16", "1_", "1_1", "1_2") //#inference
    internal var name: String = ""
    internal var description: String = ""
    internal var username: String = ""
    internal var id = 0 //#inference
    internal var user_id = 0 //#inference
    internal var status = 0 //#inference
    internal var website = "" //#inference
    internal var languages = JSONArray() //#inference
    internal var category = 0 //#inference
    internal var magnet = "" //#inference
    internal var download = "" //#inference
    internal var hash = "" //#inference
    internal var date = "" //#inference
    internal var size = "" //#inference
    internal var seeders = 0 //#inference
    internal var leechers = 0 //#inference
    internal var completed = 0 //#inference
    internal var last_scrape = "" //#inference
    internal var fileList = JSONArray() //#inference
    ...
    fun humanReadableByteCount(bytes: Long, si: Boolean): String {
        val unit = if (si) 1000 else 1024 //#inference
        if (bytes < unit) return bytes.toString() + " B"
        val exp = (Math.log(bytes.toDouble()) / Math.log(unit.toDouble())).toInt() //#inference
        val pre = (if (si) "kMGTPE" else "KMGTPE")[exp - 1] + if (si) "" else "i" //#inference
