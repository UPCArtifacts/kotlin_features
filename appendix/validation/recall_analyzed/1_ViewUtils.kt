...
object ViewUtils { //#singleton
    ...
    fun drawableToBitmap(drawable: Drawable): Bitmap {
        if (drawable is BitmapDrawable) { //#smart_cast
            return drawable.bitmap
        }

        val bitmap = Bitmap.createBitmap(drawable.intrinsicWidth, drawable.intrinsicHeight, Bitmap.Config.ARGB_8888) //#inference
        val canvas = Canvas(bitmap) //#inference
