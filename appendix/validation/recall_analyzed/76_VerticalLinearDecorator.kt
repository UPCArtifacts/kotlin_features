...
class VerticalLinearDecorator(private val context: Context) : RecyclerView.ItemDecoration() {
    ...
    private val spacing8 by lazy { context.resources.getDimensionPixelSize(R.dimen.baseline_1x) } //#inference,property_delegation,lambda

    override fun getItemOffsets(outRect: Rect, view: View, parent: RecyclerView, state: RecyclerView.State) {
        val position = parent.getChildAdapterPosition(view) //#inference
