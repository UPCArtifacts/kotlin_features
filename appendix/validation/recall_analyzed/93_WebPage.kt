 ...
 */
sealed class WebPage( //#sealed_class
    open val url: String,
 ...
 */
data class HistoryEntry( //#data_class
 ...
 */
sealed class Bookmark( //#sealed_class
    override val url: String,
    override val title: String
) : WebPage(url, title) {
     ...
     */
    sealed class Folder( //#sealed_class
        override val url: String,
        override val title: String
    ) : Bookmark(url, title) {
 ...
 */
data class SearchSuggestion( //#data_class
    override val url: String,
    override val title: String
) : WebPage(url, title)
 ...
 */
fun String?.asFolder(): Bookmark.Folder = this //#extension_function
    ?.takeIf(String::isNotBlank) //#safe_call
    ?.let { //#safe_call,lambda
        Bookmark.Folder.Entry(
            url = "$FOLDER$this", //#string_template,func_call_with_named_arg
            title = this
        )
